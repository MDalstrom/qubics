...
from rendering.state import RenderingState
...
def draw_shape_system(
    world: World, __: Entity, state: RenderingState, viewport_transform: Transform
):
    ...
    def draw_shapes(
        ...
        state.encoder.drawPrimitives_vertexStart_vertexCount_(
            Metal.MTLPrimitiveTypeTriangle, 0, len(triangles) // 2
        )
