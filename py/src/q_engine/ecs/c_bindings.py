...
_lib_path = Path(__file__).parent.parent.parent.parent.parent / "build" / "ecs.dylib"
...
# Bindings for functions that exist in ecs.h
...
def create_world(capacity: int = 1000) -> WorldHandle:
    return WorldHandle(capacity)
